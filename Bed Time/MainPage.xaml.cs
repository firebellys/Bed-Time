...
namespace BedTime
{
    public partial class MainPage
    {
        ...
        private void ClearClick(object sender, RoutedEventArgs e)
        {
            ...
            Dispatcher.BeginInvoke(() => { this.timePicker.Value = null; });
        ...
        {
            NavigationService.Navigate(new Uri("/Wake.xaml", UriKind.Relative));
            //refreshbutton.IsEnabled = true;
        ...
        private void SelectBySleepButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/Sleep.xaml", UriKind.Relative));
